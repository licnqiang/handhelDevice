...
public class InsuranceOrderAdapter extends RecyclerView.Adapter<InsuranceOrderAdapter.SelectedPicViewHolder> {
    private Context mContext;
    private List<InsuranceBean.InsuranceListBean> mData;
    ...
    public InsuranceOrderAdapter(Context mContext, List<InsuranceBean.InsuranceListBean> data) {
        this.mContext = mContext;
        this.mInflater = LayoutInflater.from(mContext);
        this.mData = data;
    }

    public void refreshData(List<InsuranceBean.InsuranceListBean> data) {
        if (null != mData) {
            mData.clear();
        }
        mData.addAll(data);
    ...
    public void addAll(List<InsuranceBean.InsuranceListBean> data) {
        mData.clear();
        mData.addAll(data);
        notifyDataSetChanged();
    }
    ...
    public class SelectedPicViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(final int position) {
            ...
            InsuranceBean.InsuranceListBean rowsBean = mData.get(position);
