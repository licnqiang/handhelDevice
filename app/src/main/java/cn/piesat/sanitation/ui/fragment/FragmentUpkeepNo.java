...
public class FragmentUpkeepNo extends BaseFragment implements UpKeepOrderAdapter.OnRecyclerViewItemClickListener,UpKeepReportContract.getUpkeepNoReportSIView{
    ...
    protected void initView() {
        ...
        springView.setListener(new SpringView.OnFreshListener() {
            ...
            public void onRefresh() {
                pageNum=1;
                upkeepReportPresenter.getUpkeepNoReportList(pageNum);
            }
