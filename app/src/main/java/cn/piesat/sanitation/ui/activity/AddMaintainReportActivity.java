 ...
 */
public class AddMaintainReportActivity extends BaseActivity {
...
//                        PhotoTool.openLocalImage(AddMaintainReportActivity.this);
//                    }
//                }).addSheetItem("拍照", null, new ActionSheetDialog.OnSheetItemClickListener() {
//                    @Override
//                    public void onClick(int which) {
//                        PhotoTool.openCameraImage(AddMaintainReportActivity.this);
//                    }
//                });
//        dialog.show();
//    }
