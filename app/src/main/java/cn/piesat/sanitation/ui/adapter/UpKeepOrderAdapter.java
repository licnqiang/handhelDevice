...
public class UpKeepOrderAdapter extends RecyclerView.Adapter<UpKeepOrderAdapter.SelectedPicViewHolder> {
    private Context mContext;
    private List<UpKeepList.RecordsBean> mData;
    ...
    public UpKeepOrderAdapter(Context mContext, List<UpKeepList.RecordsBean> data) {
        this.mContext = mContext;
        this.mInflater = LayoutInflater.from(mContext);
        this.mData = data;
    }

    public void refreshData(List<UpKeepList.RecordsBean> data) {
        if (null != mData) {
            mData.clear();
        }
        mData.addAll(data);
    ...
    public void addAll(List<UpKeepList.RecordsBean> data) {
        mData.clear();
        mData.addAll(data);
        notifyDataSetChanged();
    }
