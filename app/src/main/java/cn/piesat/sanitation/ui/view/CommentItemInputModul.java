 ...
 * @describe TODO
 */
public class CommentItemInputModul extends LinearLayout {
    TextView itemTitle;
    EditText itemValue;

    public CommentItemInputModul(Context context) {
        super(context);
    }


    public CommentItemInputModul(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CommentItemInputModul(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        LayoutInflater.from(getContext()).inflate(R.layout.comment_item_input_modul, this, true);
