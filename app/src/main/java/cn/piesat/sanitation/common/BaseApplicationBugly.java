 ...
 * @since 2016/11/15
 */
public class BaseApplicationBugly extends TinkerApplication {
    public BaseApplicationBugly() {
        super(ShareConstants.TINKER_ENABLE_ALL, "cn.piesat.sanitation.common.BaseApplication",
