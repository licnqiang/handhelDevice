...
import static cn.piesat.sanitation.util.PhotoUtils.getDataColumn;
import static cn.piesat.sanitation.util.PhotoUtils.isDownloadsDocument;
import static cn.piesat.sanitation.util.PhotoUtils.isExternalStorageDocument;
import static cn.piesat.sanitation.util.PhotoUtils.isGooglePhotosUri;
import static cn.piesat.sanitation.util.PhotoUtils.isMediaDocument;
...
//            Cursor cursor = context.getContentResolver().queryCollect(uri, new String[]{MediaStore.Images.ImageColumns.DATA}, null, null, null);
            if (null != cursor) {
