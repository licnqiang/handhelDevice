package cn.piesat.retrofitframe.ui.view.banner;
...
public class PageShowView extends View {
  ...
  protected void initColor() {
    colorCurrent = getResources().getColor(R.color.color_919191);

    colorOther = getResources().getColor(R.color.color_black);
